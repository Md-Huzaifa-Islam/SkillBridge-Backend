...
/**
  ...
  /**
   * `prisma.available`: Exposes CRUD operations for the **Available** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more Availables
    * const availables = await prisma.available.findMany()
    * ```
    */
  get available(): Prisma.AvailableDelegate<ExtArgs, { omit: OmitOpts }>;
